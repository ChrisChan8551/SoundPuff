...
<img src="https://user-images.githubusercontent.com/103156299/192941786-1fcc31d6-998f-4d96-9db9-57b99fecaae8.png" width="800" height="600">
...
* Request
  * Method: GET
  * URL: api/users/username/playlist
  * Body: none
...
* Error response: Couldn't find an Artist with the username
  * Status Code: 404
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST  
  * URL: api/users/:userId/playlist/:playlistId/songs
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: api/users/:userId/playlist/:playlistId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: api/users/:userId/album/:albumId
  * Headers:
    * Content-Type: application/json
  * Body:
